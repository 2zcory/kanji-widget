...
class KanjiRankingRepository(private val context: Context) {
    ...
    fun getRanking(scope: RankingScope, limit: Int = 10): KanjiStudyRanking {
        ...
        val dateRange = scope.toDateRange()
        val aggregateByKanji = linkedMapOf<String, Aggregate>()
        ...
        prefs.all.forEach { (key, value) ->
            ...
            val aggregate = aggregateByKanji.getOrPut(kanji) { Aggregate() }
    ...
    private fun RankingScope.toDateRange(): ClosedRange<LocalDate> {

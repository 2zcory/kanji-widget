...
- 2026-03-13: The user confirmed PR `#7` passed review. PR `#7` was merged into `master`, local `master` was fast-forwarded to merge commit `4dfca9e`, and this checklist is now archived pending a future tagged release for `First released in`.
